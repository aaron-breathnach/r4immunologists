...
Most of us will be familiar with working with tables, so we it might help to think of data frames as tables.
...
Note that I won't be discussing Bioconductor packages today. I will run a second workshop on doing bioinformatics in R.

...
In this example, I'll use the `metabolites.tsv` dataset, which includes the concentrations of 25 metabolites in 20 mice: 10 mice were fed a standard-fat diet (SFD), and 10 mice were fed a high-fat diet (HFD).
...
```{r}
res_shapiro <- rstatix::shapiro_test(dat_unpaired, mfi)
res_shapiro
```
